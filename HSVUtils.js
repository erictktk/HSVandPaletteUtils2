 ...
 *
 * @param {Array<Int>} hsv - in form [h, s, v]
 * @returns {Array<Number>}
 */
 ...
 *
 * @param {Array<Int>} rgb - color in
 * @param {Number} hueMod - from range 0 to 360
 * @param {Number} saturateMod - from range 0 to 100
 * @param {Number} valueMod - from range 0 to 100
